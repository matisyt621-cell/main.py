...
# --- 3. INTERFEJS ---
st.set_page_config(page_title="OMEGA V12.52", layout="wide")
st.title("Ω OMEGA V12.52 - PINTEREST FIX")
...
# --- 4. WRZUCANIE PLIKÓW (ROZSZERZONY FIX NA PINTEREST) ---
col1, col2, col3 = st.columns(3)

with col1:
    # Dodano webp i jfif - Pinterest często tak zapisuje pliki
    u_cov = st.file_uploader("🖼️ OKŁADKI", accept_multiple_files=True, type=["jpg", "png", "jpeg", "webp", "jfif"], key="c_mob")
with col2:
    u_pho = st.file_uploader("📷 ZDJĘCIA", accept_multiple_files=True, type=["jpg", "png", "jpeg", "webp", "jfif"], key="p_mob")
with col3:
    u_mus = st.file_uploader("🎵 MUZYKA", accept_multiple_files=True, type=["mp3", "wav", "m4a"], key="m_mob")
